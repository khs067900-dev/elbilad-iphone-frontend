  ...
  return (
    <div className="flex flex-col gap-3 p-3 sm:gap-4 sm:p-4">
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg,#E6F4F7,#D1EBF0)", border: "1px solid #9DD4E0" }}
      >
        <p className="text-[10px] sm:text-xs font-bold text-[#0d4a5e] uppercase tracking-widest">الدفعة المطلوبة الآن</p>
        <p className="text-3xl sm:text-5xl font-black mt-1 sm:mt-2" style={{ color: "#1F7A8C" }}>
          {fmt(PRE_ORDER_DEPOSIT)}
        </p>
        <p className="text-sm sm:text-base font-bold text-[#155E6F] mt-0.5 sm:mt-1">ريال سعودي</p>
        <p className="text-[10px] sm:text-[11px] text-[#0d4a5e] mt-1 sm:mt-2 text-center px-3 sm:px-4 leading-relaxed">
      ...
      <div className="flex flex-col gap-1.5 sm:gap-2 px-1">
        {[
          ...
          <div key={text} className="flex items-center gap-2">
            <Icon size={12} style={{ color: "#1F7A8C", flexShrink: 0 }} />
      ...
      <button
        ...
        style={{ background: "linear-gradient(135deg, #1F7A8C, #155E6F)" }}
      >
        المتابعة إلى الدفع
      </button>
