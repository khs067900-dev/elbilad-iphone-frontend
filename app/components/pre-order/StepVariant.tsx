...
export function StepVariant({ product, onNext }: {
  ...
  // Initialize with first variant's color or empty string
  ...
  // Find active variant based on selected color
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: color === v.color
                    ? "0 0 0 2px #fff, 0 0 0 3.5px #1F7A8C"
            ...
            {storageOpts.map(opt => {
              ...
              return (
                <button
                  ...
                  style={{
                    borderColor: active ? "#1F7A8C" : "#E5E7EB",
                    background: active ? "#E6F4F7" : "#fff",
                    color: active ? "#0d4a5e" : "#374151",
                  }}
                >
                  <span className="text-[10px] sm:text-xs font-bold">{opt.storage}</span>
                  <span className="text-[9px] sm:text-[10px] font-semibold mt-0.5" style={{ color: active ? "#1F7A8C" : "#9CA3AF" }}>
                    {fmt(p)} ر.س
                  </span>
                </button>
              );
